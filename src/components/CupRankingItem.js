...
const CupRankingItem = ({ cup, color, onPress }) => {
  return (
    <TouchableOpacity testID={`ranking-item-${cup.CupRankingId}`} onPress={onPress} style={{ alignItems: 'center', flexDirection: 'row', backgroundColor: 'white', borderRadius: 10, marginBottom: 6, padding: 16}}>
